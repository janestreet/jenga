(* OASIS_START *)
(* DO NOT EDIT (digest: ed00d8fdc77e601ac1a415a130d3dd0f) *)
module OASISGettext = struct
(* # 21 "/mnt/local/sda1/jdimino/opam-tmp/system/build/oasis.0.3.0/src/oasis/OASISGettext.ml" *)
...
(* # 21 "/mnt/local/sda1/jdimino/opam-tmp/system/build/oasis.0.3.0/src/oasis/OASISExpr.ml" *)
...
(* # 21 "/mnt/local/sda1/jdimino/opam-tmp/system/build/oasis.0.3.0/src/base/BaseEnvLight.ml" *)
...
(* # 21 "/mnt/local/sda1/jdimino/opam-tmp/system/build/oasis.0.3.0/src/plugins/ocamlbuild/MyOCamlbuildFindlib.ml" *)
...
(* # 21 "/mnt/local/sda1/jdimino/opam-tmp/system/build/oasis.0.3.0/src/plugins/ocamlbuild/MyOCamlbuildBase.ml" *)
...
(* # 56 "/mnt/local/sda1/jdimino/opam-tmp/system/build/oasis.0.3.0/src/plugins/ocamlbuild/MyOCamlbuildBase.ml" *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("jenga_lib", ["lib"])];
     lib_c = [];
     flags = [];
     includes = [("bin", ["lib"])];
     }
