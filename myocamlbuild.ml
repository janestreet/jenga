(* OASIS_START *)
(* DO NOT EDIT (digest: 4a87cd3ababd8f15ba24edfe462f7f96) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("tenacious_sample_lib", ["tenacious/sample-lib"], []);
          ("tenacious_lifetime_lib", ["tenacious/lifetime-lib"], []);
          ("tenacious_lib", ["tenacious/lib"], []);
          ("jenga_lib", ["lib"], []);
          ("jenga_archive", ["bin"], [])
       ];
     lib_c = [("jenga_archive", "bin", [])];
     flags = [];
     includes =
       [
          ("tenacious/lib",
            ["tenacious/lifetime-lib"; "tenacious/sample-lib"]);
          ("lib", ["tenacious/lib"]);
          ("bin", ["lib"])
       ]
  }
