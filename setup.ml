(* OASIS_START *)
(* DO NOT EDIT (digest: 311cfb3f3ba4fcbc652e24f7f50f6017) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "dump_jenga_state.ml";
                      })
            ];
          plugins =
            [
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "9\254\159\153E\155L\212\135C* \225\178\242\198";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
