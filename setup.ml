(* OASIS_START *)
(* DO NOT EDIT (digest: 03934db38c55e3be9810419c389cdb98) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "jenga_offline_standalone.ml";
                      });
               Executable
                 ({
                     cs_name = "jem";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "w\173\134j\138\212\b`Fo\200\019\236@\162\196";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
