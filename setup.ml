(* OASIS_START *)
(* DO NOT EDIT (digest: 3192d7e0ff2ddc4a2278f800d191b731) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Heart"; "Tenacious_sample"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tenacious_lib";
                      lib_findlib_name = Some "sample";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "tenacious_lifetime_lib";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "tenacious/lifetime-lib";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("async", None);
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tenacious_lib";
                      lib_findlib_name = Some "lifetime";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "tenacious_lib";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "tenacious/lib";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("core", None);
                           FindlibPackage ("async", None);
                           InternalLibrary "tenacious_sample_lib";
                           InternalLibrary "tenacious_lifetime_lib";
                           FindlibPackage ("threads", None);
                   ...
                   {
                      lib_modules = ["Tenacious_intf"; "Tenacious"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "jenga_lib";
                      lib_findlib_name = Some "tenacious";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("async_shell", None);
                           ...
                           FindlibPackage ("ocaml_plugin", None);
                           FindlibPackage ("pcre", None);
                           FindlibPackage ("sexplib", None);
                           FindlibPackage ("sexplib.syntax", None);
                           FindlibPackage ("str", None);
                           FindlibPackage ("threads", None);
                           InternalLibrary "tenacious_lib"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Jenga_archive_dummy"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "jenga_offline.ml"});
               Executable
                 ({
                     cs_name = "jem";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "jenga_lib";
                           FindlibPackage ("ocaml_plugin.fake", None);
                           FindlibPackage ("threads", None)
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                   ...
                   {exec_custom = false; exec_main_is = "jem.ml"})
            ];
          plugins =
            [
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\239=A\183\195\241\132\016\022\212\r~\243\187g\004";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
