(* OASIS_START *)
(* DO NOT EDIT (digest: 692538640a11b0db17052aef1b945105) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("pa_structural_sexp.syntax", None);
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "F\203\1655\023\210\144T\n,\208\163\169\014\225\228";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
